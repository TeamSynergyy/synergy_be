...
public class ProjectLikeController {
    ...
    public ResponseEntity<ProjectLikeResponse> updateProjectLike(@PathVariable("projectId") String projectId, @RequestBody ProjectLikeType type, @LoginUser String userId) {
