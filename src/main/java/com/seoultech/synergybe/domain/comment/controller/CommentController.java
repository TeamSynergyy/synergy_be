...
public class CommentController {
    ...
    @PostMapping
    public ResponseEntity<GetCommentResponse> createComment(@RequestBody CreateCommentRequest request, @LoginUser String userId) {
    ...
    @PutMapping
    public ResponseEntity<GetCommentResponse> updateComment(@RequestBody CreateCommentRequest request) {
    ...
    @DeleteMapping
    public ResponseEntity<GetCommentResponse> deleteComment(@RequestBody CreateCommentRequest request) {
    ...
    public ResponseEntity<List<GetCommentResponse>> getCommentList(@PathVariable("postId") Long postId) {
